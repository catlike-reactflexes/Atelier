 ...
 */
 ...
 import PhotoAns from ' ../../../client/src/components/questionAnswer/PhotoAns.jsx';
 ...
 describe('Photos from answers component', function () {
  test('Should render Photo Answer component', function () {

    const {container} = render(<PhotoAns test_urlPhoto={test_urlPhoto}/>)
